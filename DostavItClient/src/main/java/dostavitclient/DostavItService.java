...
public class DostavItService {
    ...
    public static CarrierInfo getCarrier(String carrier) throws DostavItServiceException {
        validateNotNull(carrier, "Carrier name should not be null");
        try {
            String response = sendGetRequest(String.format("http://dostav.it/api/carriers/%s", carrier));
            ...
            throw createDostavItServiceException("Error getting carrier: " + carrier, e);
        }
    }
